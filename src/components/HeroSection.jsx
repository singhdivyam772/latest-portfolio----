...
const HeroSection = () => {
  return (
    <div>
      <div className=' w-full md:h-[82vh] h-[100vh] hero-section flex flex-wrap justify-center items-center'>  
        {/* intro */}
        <div className=' min-w-[30vw]  flex flex-col justify-center items-center'>
          ...
          <button className=' bg-[#7843E9] md:px-16 px-10 py-3 rounded-md uppercase font-bold mb-6 text-white tracking-wider mt-6 transform transition-transform hover:scale-110 z-0 '>
            Projects
          </button>
        </div>
      </div>
